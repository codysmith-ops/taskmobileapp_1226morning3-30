...
export const TASK_CATEGORIES = {
  ...
  returns: { label: 'Returns', color: '#EF4444', icon: '↩️' },
  hardware: { label: 'Hardware', color: '#F59E0B', icon: '🔨' },
  retail: { label: 'Retail', color: '#3B82F6', icon: '🏪' },
  medical: { label: 'Medical', color: '#8B5CF6', icon: '⚕️' },
  home: { label: 'Home', color: '#14B8A6', icon: '🏠' },
